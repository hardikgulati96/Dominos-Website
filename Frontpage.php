                             ...
                             <div id="overlaySignup">
                                 ...
                                 <div id="formUp">
                                     <form action="Frontpage.php" method="post">
                                         <input  class ="textInput" type="text" id="name1" name="name" placeholder="Name" onkeyup="checkname();" required>
                                         <span class="error" id="ename"></span>
                                         
                                         <br/><br/>
                                         <input  class ="textInput" type="text" id="username" name="n" placeholder="Username" onkeyup="checkusername()" required>
                                         <span class="error" id="euser"></span>
                                         <br/><br/>
                                         <input  class ="textInput" type="password" id="pass" name="p" placeholder="Password" onkeyup="checkpass();" required>
                                         <span class="error"  id="epass"></span>
                                         <br/><br/>
                                         <input  class ="textInput" type="password" id="cpass" name="pd" placeholder="Confirm Password" onkeyup="confirmpass();" onchange="javascript:validatepw()">
                                         <span class="error"  id="ecpass"></span>
                                         <br/><br/>
                                         <input class ="textInput" type="text" id="phone" name="phone" placeholder="Phone" onkeyup="checkphone();">
                                         ...
                                         <br/><br/>
                                         <input class ="textInput" type="text" id="pincode" name="pin" placeholder="Pincode" onkeyup="checkpin();">
                                         <span class="error"  id="epin"></span>
                                         <br/><br>
                                         <input type="checkbox" name="check" onchange="checkerror();" required/>
                                         
                                         <label for="check">I agree with your Terms and Privacy Policy</label>
                                         <input id="supsubmit" class="submit" type="submit" value="Sign Up" name="submit1">
                                         <input class="close" id="supclose" type="button" value="Close" onclick="closeOverlay();">
                                     </form>
                                 </div>
